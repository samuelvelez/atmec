    ...
    function picture_compress(e) {
        ...
        reader.onload = event => {
            ...
            img.onload = () => {
                ...
                var width = <?php echo e(env('APP_UPLOADED_IMAGE_WIDTH', 600)); ?>;
                var height = width / ar;
...
<?php /**PATH /Users/samuel/Documents/proyectos/Saveme/atm2/nuevo/resources/views/scripts/resize-image-before-upload.blade.php ENDPATH**/ ?>