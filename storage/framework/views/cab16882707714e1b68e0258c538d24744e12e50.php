<script type="text/javascript">
    ...
    function show_geocoding() {
        ...
        return geocoder.geocode({'address': <?php echo old('google_address') ? '"' . old('google_address') . '"' : '"Guayaquil"'; ?> }, function (results, status) {
            if (status == google.maps.GeocoderStatus.OK) {
...
<?php /**PATH /Users/samuel/Documents/proyectos/Saveme/atm2/nuevo/resources/views/scripts/google-maps-atm-create.blade.php ENDPATH**/ ?>