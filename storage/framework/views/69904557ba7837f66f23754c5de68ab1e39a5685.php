<table class="table table-striped table-sm data-table">
    ...
    <tr>
        ...
        <th><?php echo trans('verticalsignals.vsignals-table.latitude'); ?></th>
        <th><?php echo trans('verticalsignals.vsignals-table.longitude'); ?></th>
    ...
    <tr>
        ...
        <th><?php echo trans('traffic-lights.traffic-lights-table.brand'); ?></th>
        <th><?php echo trans('traffic-lights.traffic-lights-table.fastener'); ?></th>
        <th><?php echo trans('traffic-lights.traffic-lights-table.state'); ?></th>
    ...
    <tr>
        ...
        <th><?php echo trans('regulator-boxes.regulator-boxes-table.code'); ?></th>
        <th><?php echo trans('regulator-boxes.regulator-boxes-table.erp_code'); ?></th>
        <th><?php echo trans('regulator-boxes.regulator-boxes-table.brand'); ?></th>
        <th><?php echo trans('regulator-boxes.regulator-boxes-table.state'); ?></th>
...
</table><?php /**PATH /Users/samuel/Documents/proyectos/Saveme/atm2/nuevo/resources/views/georeports/tables/geo-table.blade.php ENDPATH**/ ?>