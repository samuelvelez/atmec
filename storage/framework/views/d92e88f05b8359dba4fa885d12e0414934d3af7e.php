<?php $__env->startSection('template_title'); ?>
    <?php echo trans('ito-templates.editing-template', ['id' => $template->id]); ?>
        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        <?php echo Form::open(array('route' => ['ito-templates.update', $template->id], 'method' => 'PUT', 'role' => 'form', 'class' => 'needs-validation')); ?>
                        ...
                        <div class="form-group has-feedback row <?php echo e($errors->has('name') ? ' has-error ' : ''); ?>">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <?php echo Form::text('name', $template->name, array('id' => 'name', 'class' => 'form-control', 'placeholder' => trans('ito-templates.create_ph_name'))); ?>
                        ...
                        <div class="form-group has-feedback row <?php echo e($errors->has('description') ? ' has-error ' : ''); ?>">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <?php echo Form::textarea('description', $template->description, array('id' => 'description', 'rows' => '3', 'class' => 'form-control', 'placeholder' => trans('ito-templates.create_ph_description'))); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="input-group">
                                    <?php echo Form::text('amount', null, array('id' => 'amount', 'class' => 'form-control mr-4', 'placeholder' => '1')); ?>
                        ...
                        <?php echo Form::button(trans('ito-templates.edit_button_text'), array('class' => 'btn btn-primary margin-bottom-1 mb-1 float-right','type' => 'submit' )); ?>
...
<?php $__env->startSection('footer_scripts'); ?>
    ...
    <script>
        $(document).ready(function () {
            let data = <?php echo json_encode($template->materials()->with(['material','metric_unit'])->get()); ?>;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/atmdeveqadoor/resources/views/ito-templates/edit.blade.php ENDPATH**/ ?>