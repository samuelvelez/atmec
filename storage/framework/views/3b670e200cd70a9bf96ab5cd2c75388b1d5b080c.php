...
/**/
    ...
    $(function () {
        ...
        config['vsignal-filters'] = {
            url: "<?php echo e(route('vsignal-filters')); ?>",
            no_result: '<tr>' +
            ...
            excel_export: '<?php echo e(url('/georeports/signals-excel/')); ?>',
        };
        config['light-filters'] = {
            url: '<?php echo e(route('light-filters')); ?>',
            no_result: '<tr>' +
            ...
            excel_export: '<?php echo e(url('/georeports/lights-excel/')); ?>',
        };
        config['regulator-filters'] = {
            url: '<?php echo e(route('regulator-filters')); ?>',
            no_result: '<tr>' +
                '<td><?php echo trans("traffic-lights.search.no-results"); ?></td>' +
                '<td></td>' +
                '<td></td>' +
            ...
            excel_export: '<?php echo e(route('regulators-excel')); ?>',
        };
        ...
        add_signal_marker = function (val) {
            ...
            google.maps.event.addListener(marker, 'click', function () {
                var url = '<?php echo e(URL::to('vertical-signals/')); ?>' + '/' + val.id;
        ...
        add_light_marker = function (val) {
            ...
            google.maps.event.addListener(marker, 'click', function () {
                var url = '<?php echo e(URL::to('traffic-lights/')); ?>' + '/' + val.id;
        ...
        add_regulator_marker = function (val) {
            ...
            google.maps.event.addListener(marker, 'click', function () {
                var url = '<?php echo e(URL::to('regulator-boxes/')); ?>' + '/' + val.id;
...
<?php /**PATH /Users/samuel/Documents/proyectos/Saveme/atm2/nuevo/resources/views/scripts/filter-geolocation.blade.php ENDPATH**/ ?>