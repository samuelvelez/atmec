...
Route::group(['middleware' => ['auth', 'activated', 'role:atmadmin|atmcollector|atmoperator', 'activity', 'twostep', 'checkblocked']], function () {
...
Route::group(['middleware' => ['auth', 'activated', 'role:atmadmin|atmstockkeeper', 'activity', 'twostep', 'checkblocked']], function () {
...
Route::group(['middleware' => ['auth', 'activated', 'role:atmadmin|atmoperator|atmcollector', 'activity', 'twostep', 'checkblocked']], function () {
