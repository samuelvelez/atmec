...
class TrafficPoleController extends Controller
{
    ...
    public function index()
    {
        ...
        $poles = TrafficPole::orderby('updated_at', 'desc');
    ...
    public function search(Request $request)
    {
        ...
        $result = TrafficPole::select()->join('intersections', 'traffic_poles.intersection_id', '=', 'intersections.id')
            ->where('code', 'like', '%' . $searchTerm . '%')
            ->orWhere('state', 'like', '%' . $searchTerm . '%')
            ->orWhere('material', 'like', '%' . $searchTerm . '%')
            ->orWhere('traffic_poles.google_address', 'like', '%' . $searchTerm . '%')
            ->orWhere('traffic_poles.comment', 'like', '%' . $searchTerm . '%')
            ->orWhere('intersections.main_st', 'like', '%' . $searchTerm . '%')
            ->orWhere('intersections.cross_st', 'like', '%' . $searchTerm . '%')
            ->orWhere('height', '=', $searchTerm)
            ->orWhere('erp_code', 'like', '%' . $searchTerm . '%')->with('intersection')->get();
