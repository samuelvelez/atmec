...
document.getElementById("latitudg").value = latitud;
document.getElementById("longitudg").value = longitud;
}
...
<input type="hidden" name="latitudg" id="latitudg" value="">
<input type="hidden" name="longitudg" id="longitudg" value="">
<input type="submit" value="Ubícame">
</form>
...
<?php        
        ...
        if (isset($_REQUEST['longitudg'])){
            $alert->longitude=$_REQUEST['longitudg'];
        $alert->latitude =$_REQUEST['latitudg'];
        
//                $alert->latitude = -2.1938822;
//        $alert->longitude = -79.8917524;
        ...
        return view('ubicacion.create', compact('collectors', 'alert', 'novelties', 'subnovelties',
