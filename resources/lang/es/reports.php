...
return [
    ...
    'create-new-report'       => 'Crear nuevo reporte para la alerta #:id',
    'editing-report'          => 'Editando el reporte :id',
    'showing-report-title'    => 'Mostrando el reporte :id',
    ...
    'buttons' => [
        ...
        'back-to-reports' => '<span class="hidden-sm hidden-xs">Regresar a </span><span class="hidden-xs">reportes</span>',
    ],
    ...
    'tooltips' => [
        ...
        'back-reports'   => 'Regresar a reportes'
    ],
    ...
    'create_ph_description' => 'Escriba la descripción para el reporte.',
];
