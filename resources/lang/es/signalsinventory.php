...
return [
    ...
    // Titles
    'showing-all-signals-inventories'     => 'Mostrando el inventario de señales',
    ...
    'signals-inventories-table' => [
        'caption'   => ':signals-inventoriescount/:inventoriestotal tipos de señales.',
        'id'        => 'ID',
        'code'      => 'Código',
        'name'     => 'Nombre',
        'group'     => 'Grupo',
    ...
    'buttons' => [
        ...
        'back-to-signals-inventory'  => '<span class="hidden-xs">Regresar a la señal</span>',
