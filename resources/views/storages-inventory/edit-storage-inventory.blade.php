...
<option value="{{ $value->id }}" {{ $device->storage_id == $value->id ? 'selected' : '' }}>{{ $value->name }}</option>                                                
...
<option value="{{ $value->id }}" {{ $device->device_id == $value->id ? 'selected' : '' }}>{{ $value->name }}</option>                                                
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('name') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::number('quantity', $device->quantity, array('id' => 'quantity', 'class' => 'form-control', 'placeholder' => trans('Ingrese la cantidad'))) !!}
