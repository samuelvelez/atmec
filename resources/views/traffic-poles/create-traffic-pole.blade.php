                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('code') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::text('code', NULL, array('id' => 'code', 'disabled' => true, 'class' => 'form-control', 'placeholder' => trans('forms.create_traffic_pole_ph_code'))) !!}
                                    <div class="input-group-append">
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('erp_code') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::text('erp_code', NULL, array('id' => 'erp_code', 'disabled' => true, 'class' => 'form-control', 'placeholder' => trans('forms.create_traffic_pole_ph_erp_code'))) !!}
                                    <div class="input-group-append">
