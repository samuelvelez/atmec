<script type="text/javascript" src="{{ config('atm_app.jsPDFJsCdn') }}"></script>
<script type="text/javascript" src="{{ config('atm_app.momentJsCDN') }}"></script>
...
<script type="text/javascript">
    $(function () {
        $('#save-image-btn').click(function (event) {
            ...
            getDataUri('{{ asset('images/atm-logo.png') }}', function (logo) {
                ...
                html2canvas(mapElement, {
                    ...
                    onrendered: function (canvas) {
                        ...
                        var text = 'Generado por: {{ \Illuminate\Support\Facades\Auth::user()->full_name() }} el ' + moment().format('DD/MM/YYYY, h:mm:ss a');
