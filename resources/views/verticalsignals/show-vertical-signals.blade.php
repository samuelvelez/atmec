                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="btn-group pull-right btn-group-xs">
                                <a class="btn btn-primary btn-sm" href="/vertical-signals/create">
                                    ...
                                    <span class="hidden-xs">{!! trans('verticalsignals.buttons.create-new') !!}</span>
                                </a>

                                <a href="{{ URL::to('vertical-signals/export/xlsx') }}" class="btn btn-success btn-sm float-right ml-2"
                                ...
                                @foreach($vsignals as $vsignal)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {!! Form::button(trans('verticalsignals.buttons.delete'), array('class' => 'btn btn-danger btn-sm','type' => 'button', 'style' =>'width: 100%;' ,'data-toggle' => 'modal', 'data-target' => '#confirmDelete', 'data-title' => 'Eliminar señal vertical', 'data-message' => '¿Está seguro que desea eliminar esta señal? ¡Eliminará con ella todas sus dependencias!')) !!}
                                            {!! Form::close() !!}
                                        </td>
                                        @endrole
                                    </tr>
