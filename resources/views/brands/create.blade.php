        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                <div class="card">
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="pull-right">
                                <a href="{{ route('brands.index') }}" class="btn btn-light btn-sm float-right"
                                   data-toggle="tooltip" data-placement="left"
                                   title="{{ trans('signal-subgroups.tooltips.back-signal-subgroups') }}">
                                    <i class="fa fa-fw fa-reply-all" aria-hidden="true"></i>
                                    {!! trans('brands.buttons.back-to-brands') !!}
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        {!! Form::open(array('route' => 'brands.store', 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation')) !!}

                        {!! csrf_field() !!}

                        <div class="form-group has-feedback row {{ $errors->has('code') ? ' has-error ' : '' }}">
                            {!! Form::label('code', trans('brands.create_label_description'), array('class' => 'col-md-3 control-label')); !!}
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::text('code', NULL, array('id' => 'code', 'class' => 'form-control', 'placeholder' => trans('brands.create_ph_description'))) !!}
                                </div>
                                @if ($errors->has('code'))
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <select name="group" id="group">
                                        <option value="">{{ trans('brands.create_ph_brandtype') }}</option>
