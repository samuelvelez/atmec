...
@section('template_title')
    {!! trans('brands.showing-signal-subgroup', ['id' => $subgroup->id]) !!}
@endsection
                    ...
                    <div class="card-header text-white bg-success">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="float-right">
                                <a href="{{ route('brands.index') }}" class="btn btn-light btn-sm float-right"
                                   ...
                                   title="{{ trans('brands.tooltips.back-signal-subgroups') }}">
                        ...
                        <div class="col-sm-6 col-6">
                                    <strong class="text-larger">
                                        {{ trans('brands.show-signal-subgroup.id') }}
                                    </strong>
                                    <div class="row">
                            ...
                            <div class="col-sm-6 col-6">
                                @if ($subgroup->description)
                                    <strong class="text-larger">
                                        {{ trans('brands.show-signal-subgroup.tipo') }}
                                    </strong>
                                    <div class="row">
                                        <div class="col-sm-12 col-12">
