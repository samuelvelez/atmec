...
@section('template_title')
    {!! trans('ito-templates.create-new-template') !!}
@endsection
        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        {!! Form::open(array('route' => 'ito-templates.store', 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation')) !!}
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('name') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::text('name', NULL, array('id' => 'name', 'class' => 'form-control', 'placeholder' => trans('ito-templates.create_ph_name'))) !!}
                                </div>
                                @if ($errors->has('name'))
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('description') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::textarea('description', NULL, array('id' => 'description', 'rows' => '3', 'class' => 'form-control', 'placeholder' => trans('ito-templates.create_ph_description'))) !!}
                                </div>
                        ...
                        {!! Form::button(trans('ito-templates.create_button_text'), array('class' => 'btn btn-success margin-bottom-1 mb-1 float-right','type' => 'submit' )) !!}
                        {!! Form::close() !!}
                    </div>
