...
@section('template_title')
    {!! trans('itorders.editing-itorder', ['id' => $itorder->id]) !!}
@endsection
        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        {!! Form::open(array('route' => ['itorders.update', $itorder->id], 'method' => 'PUT', 'role' => 'form', 'class' => 'needs-validation')) !!}
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('template') ? ' has-error ' : '' }}">
                            {!! Form::label('template', 'Plantilla', array('class' => 'col-md-3 control-label')); !!}
                            <div class="col-md-9">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="input-group">
                                    {!! Form::text('amount', null, array('id' => 'amount', 'class' => 'form-control mr-4', 'placeholder' => '##')) !!}
                        ...
                        {!! Form::button(trans('itorders.create_button_text'), array('class' => 'btn btn-success margin-bottom-1 mb-1 float-right','type' => 'submit' )) !!}
                        {!! Form::close() !!}
                    </div>
...
@section('footer_scripts')
    ...
    <script>
        $(document).ready(function () {
            let data = {!! json_encode($itorder->materials()->with(['material','metric_unit'])->get()) !!};
            ...
            $("#collector")[0].selectize.addItem({{ $itorder->collector_id }});
