...
@section('template_title')
    {!! trans('traffic-light-type.create-new-tlt') !!}
@endsection
        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                <div class="card">
                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="pull-right">
                                <a href="{{ route('traffic-light-type.index') }}" class="btn btn-light btn-sm float-right"
                                   ...
                                   title="{{ trans('traffic-light-type.tooltips.back-signal-subgroups') }}">
                                    <i class="fa fa-fw fa-reply-all" aria-hidden="true"></i>
                                    {!! trans('traffic-light-type.buttons.back-to-tlt') !!}
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        {!! Form::open(array('route' => 'traffic-light-type.store', 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation')) !!}

                        {!! csrf_field() !!}

                        <div class="form-group has-feedback row {{ $errors->has('code') ? ' has-error ' : '' }}">
                            {!! Form::label('code', trans('traffic-light-type.create_label_description'), array('class' => 'col-md-3 control-label')); !!}
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::text('code', NULL, array('id' => 'code', 'class' => 'form-control', 'placeholder' => trans('traffic-light-type.create_ph_description'))) !!}
                                </div>
                                @if ($errors->has('code'))
