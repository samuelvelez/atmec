                        ...
                        <div class="table-responsive intersections-table">
                            <table class="table table-striped table-sm data-table">
                                <caption id="intersection_count">
                                    {{ trans_choice('intersections.intersections-table.caption', 1, ['intersectionscount' => $intersections->count(), 'intersectionstotal' => $intersectionstotal]) }}
                                </caption>
                                <thead class="thead">
                                <tr>
                                    <th>{!! trans('intersections.intersections-table.id') !!}</th>
                                ...
                                @foreach($intersections as $intersection)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {!! Form::close() !!}
                                            {!! Form::button(trans('intersections.buttons.delete'), array('class' => 'btn btn-danger btn-sm','type' => 'button', 'style' =>'width: 100%;' ,'data-toggle' => 'modal', 'data-target' => '#confirmDelete', 'data-title' => 'Eliminar Intersección', 'data-message' => '¿Está seguro que desea eliminar la intersección? ¡Eliminará con ella todas sus dependencias!')) !!}
                                        </td>
                                        @endrole
                                    </tr>
                                @endforeach
