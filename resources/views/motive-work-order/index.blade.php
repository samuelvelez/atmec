...
@section('template_title')
    {!! trans('motive-wo.showing-all-motives') !!}
@endsection
                ...
                <div class="card">
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="btn-group pull-right btn-group-xs">
                                <a class="btn btn-primary btn-sm" href="/motive-work-order/create">
                                    <i class="fa fa-fw fa-plus" aria-hidden="true"></i>
                                    <span class="hidden-xs">{!! trans('motive-wo.buttons.create-new') !!}</span>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive subgroups-table">
                            @include('motive-work-order.table', [
                                'subgroups' => $subgroups,
