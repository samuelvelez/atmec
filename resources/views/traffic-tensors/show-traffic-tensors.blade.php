                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="btn-group pull-right btn-group-xs">
                                <a class="btn btn-primary btn-sm" href="/traffic-tensors/create">
                                    ...
                                    <span class="hidden-xs">{!! trans('traffic-tensors.buttons.create-new') !!}</span>
                                </a>
                            </div>
                            @endrole
                        </div>
                                ...
                                @foreach($tensors as $tensor)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {!! Form::button(trans('traffic-tensors.buttons.delete'), array('class' => 'btn btn-danger btn-sm','type' => 'button', 'style' =>'width: 100%;' ,'data-toggle' => 'modal', 'data-target' => '#confirmDelete', 'data-title' => 'Eliminar tensor', 'data-message' => '¿Está seguro que desea eliminar el tensor? ¡Eliminará con el todas sus dependencias!')) !!}
                                            {!! Form::close() !!}
                                        </td>
                                        @endrole
                                    </tr>
