...
@section('template_title')
    {!! trans('signalsinventory.create-new-signals-inventory') !!}
@endsection
        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                <div class="card">
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="pull-right">
                                <a href="{{ route('signals-inventory.index') }}" class="btn btn-light btn-sm float-right"
                    ...
                    <div class="card-body">
                        {!! Form::open(array('route' => 'signals-inventory.store', 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation', 'files' => true)) !!}
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('name') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::text('name', NULL, array('id' => 'name', 'class' => 'form-control', 'placeholder' => trans('forms.create_vsignal_ph_name'))) !!}
                                    <div class="input-group-append">
                                    ...
                                    <select class="custom-select form-control" name="subgroup" id="subgroup">
                                        ...
                                        @if ($subgroups)
                                            @foreach($subgroups as $subgroup)
                                                <option value="{{ $subgroup->id }}" {{ old('subgroup') == $subgroup->id ? 'selected' : '' }}>{{ $subgroup->group->name }}
                        ...
                        <div class="row">
                            ...
                            {!! Form::hidden("variations", null, array('id' => 'variations')) !!}
                        </div>
                        <br>
                        <div class="row">
                            <div class="col-md-12">
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('usage') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::textarea('usage', NULL, array('id' => 'usage', 'rows' => '3', 'class' => 'form-control', 'placeholder' => trans('forms.create_vsignal_ph_usage'))) !!}
                                    <div class="input-group-append">
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('description') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::textarea('description', NULL, array('id' => 'description', 'rows' => '3', 'class' => 'form-control', 'placeholder' => trans('forms.create_vsignal_ph_description'))) !!}
                                    <div class="input-group-append">
