                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="btn-group pull-right btn-group-xs">
                                <a class="btn btn-primary btn-sm" href="/signals-inventory/create">
                                    ...
                                    <span class="hidden-xs">{!! trans('signalsinventory.buttons.create-new') !!}</span>
                                </a>
                            </div>
                        </div>
                    </div>
                                ...
                                @foreach($inventories as $inventory)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {!! Form::button(trans('signalsinventory.buttons.delete'), array('class' => 'btn btn-danger btn-sm','type' => 'button', 'style' =>'width: 100%;' ,'data-toggle' => 'modal', 'data-target' => '#confirmDelete', 'data-title' => 'Eliminar tipo de señal', 'data-message' => '¿Está seguro que desea eliminar esta señal? ¡Eliminará con ella todas sus dependencias!')) !!}
                                            {!! Form::close() !!}
                                        </td>
                                        @endrole
                                    </tr>
