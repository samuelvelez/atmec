...
@section('template_title')
    {!! trans('device-types.editing-signal-subgroup', ['id' => $subgroup->id]) !!}
@endsection
        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                <div class="card">
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="pull-right">
                                ...
                                <a href="{{ url('/device-types/' . $subgroup->id) }}"
                    ...
                    <div class="card-body">
                        {!! Form::open(array('route' => ['device-types.update', $subgroup->id], 'method' => 'PUT', 'role' => 'form', 'class' => 'needs-validation')) !!}

                        {!! csrf_field() !!}


                        <div class="form-group has-feedback row {{ $errors->has('description') ? ' has-error ' : '' }}">
                            {!! Form::label('description', trans('device-types.create_label_description'), array('class' => 'col-md-3 control-label')); !!}
                            <div class="col-md-9">
