...
@section('template_title')
    {!! trans('delivery-material.create-new-report') !!}
@endsection
            ...
            <div class="col-lg-10 offset-lg-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(array('id' => 'form' ,'route' => 'delivery-material.store', 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation', 'files' => true)) !!}

                        {!! csrf_field() !!}

                        <div class="text-center" style="color: royalblue;"><strong>Datos de la entrega de materiales</strong></div>
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('description') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::textarea('description', NULL, array('id' => 'description', 'rows' => '3', 'class' => 'form-control', 'placeholder' => trans('delivery-material.create_ph_description'))) !!}
                                </div>
...
{!! Form::text('product', null, array('id' => 'product', 'class' => 'form-control mr-2', 'placeholder' => 'Nombre del producto')) !!}
...
<!--                                    <span>{{ $collectors }}</span>
  ...
  {!! Form::hidden("aprob", '', array('id' => 'aprob')) !!}
                        {!! Form::button(trans('Enviar'), array('class' => 'btn btn-success margin-bottom-1 mb-1  mr-2 float-right','type' => 'submit', 'id'=>'finalizar')) !!}
...
//                });
                ...
                if (metric.length > 0 && amount.trim().length && Number.parseInt(amount) > 0) {
