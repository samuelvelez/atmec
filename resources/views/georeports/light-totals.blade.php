...
@section('template_title')
    {!! trans('georeports.light-totals.title') !!}
@endsection
                ...
                <div class="card">
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <strong>{!! trans('georeports.light-totals.title') !!}</strong>
                            <div class="float-right">
                                {!! Form::open(array('url' => '/georeports/light-totals-excel/')) !!}
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="table-responsive totals-table">
                                @include('georeports.tables.light-totals-table', [$state_totals, $material_totals, $type_totals, $light_total])
                            </div>
                        </div>
                    </div>
                </div>
